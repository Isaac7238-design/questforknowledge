...
/**
 * GamePanel - core game class. RyiSnow Blue Boy Adventure exact structure.
...
public class GamePanel extends JPanel implements Runnable {
    ...
    // RyiSnow exact game loop with precise timing
    @Override
    public void run() {
    ...
    // ── Draw to temp screen (RyiSnow exact pattern) ───────────────
