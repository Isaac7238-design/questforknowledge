...
public class Entity {
 ...
 // Dialogue (2D array: [set][line] – style)
 ...
 /**
 * startDialogue: sets game to dialogue state, assigns npc reference.
 */
 ...
 /** setup: load PNG from classpath, scale to size. Falls back to colored rect. */
